...
using namespace std;
typedef bool (*FNCallbackPacketListenerEx)(unsigned char* buffer, int nSize,
	void* pObject);
...
public:
	...
	CString GetDeviceName() { return m_csDeviceName; }
	virtual BOOL OnInitDialog();
	afx_msg void OnPaint();
	static bool CallbackPacketListener(unsigned char* buffer, int nSize,
		void* pObject);
	...
	void SetSiteVisited(
		map<CString, map<CString, struct enz_packet_info>>* mSiteVisited) {
