...
extern "C" ENZTCPLIBRARY_API	bool        StartLocalAreaListening(const char* ipAddress,const char* subNetMask, CallbackLocalAreaListener fnpPtr, int nPollingTimeMS);
